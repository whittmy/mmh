...
elseif($ac=='digg')
{
	...
	if($tab=='art') { $pre='a_'; } else if($tab=='vod') { $tab='vod';$pre='d_'; } else{ $tab='game';$pre='d_'; }
...
elseif($ac=='score')
{
	...
	if($tab=='art') { $col='a'; } else if($tab=='vod'){ $tab='vod';$col='d'; }else{$tab='game';$col='d';}
...
elseif($ac=='suggest')
{
	...
	if(!empty($q)){
		...
		if($t=='art'){
			...
			"SELECT a_name from {pre}game WHERE a_name like '".$q."%' or a_enname like '".$q."%' ";
		}
