...
function getTabName($tab)
{
	...
	if (strpos($tab,'game_relation')>0){
		return '游戏关系';
	}
	if (strpos($tab,'game_topic')>0){
		return '游戏专题';
	}
	if (strpos($tab,'game_type')>0){
		return '游戏分类';
	}
	if (strpos($tab,'game')>0){
		return '游戏';
	}	
}
...
function getTemplateFlag($f)
{
	switch($f)
	{
		...
		case "game_index.html":$str="游戏首页模板";break;
		...
		case "game_detail.html":$str="游戏内容页";break;
		case "game_list.html":$str="游戏筛选页";break;
		case "game_type.html":$str="游戏分类页";break;
		case "game_map.html":$str="游戏地图页";break;
		case "game_play.html":$str="游戏播放页";break;
		case "game_down.html":$str="游戏下载页";break;
		case "game_search.html":$str="游戏搜索页";break;
		case "game_topicindex.html":$str="游戏专题首页";break;
		case "game_topiclist.html":$str="游戏专题数据列表";break;
		case "game_playopen.html":$str="游戏弹窗播放页面";break;		
