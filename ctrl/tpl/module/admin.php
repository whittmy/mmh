...
{
	$colarr=array('app','art','artlist','artsearch','arttopicindex','arttopiclist','client','vod','voddown','vodlist','vodplay','vodsearch','vodtopicindex','vodtopiclist','game','gamedown','gamelist','gameplay','gamesearch','gametopicindex','gametopiclist');
	$path='../cache/';
