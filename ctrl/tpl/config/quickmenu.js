var menu = {
	...
	"md":{"text":"媒体","default":"vod","children":{"server":{"text":"服务器组","url":"?m=vod-server"},"player_config":{"text":"播放器","url":"?m=vod-player"},"deviceres":{"text":"设备资源接口", "url":"?m=vod-device_res_mgr"},"catatype":{"text":"资源分类","url":"?m=vod-cata"},"restype":{"text":"资源类型", "url":"?m=vod-restype"},"vodclass":{"text":"剧情分类","url":"?m=vod-class"},"vodtopic":{"text":"资源专题","url":"?m=vod-topic"},"vodrepeat":{"text":"检测重复数据","url":"?m=vod-list-repeat-ok"},"vod":{"text":"资源数据","url":"?m=vod-list"},"vodadd":{"text":"添加资源","url":"?m=vod-info"} }},
	...
	"mf":{"text":"文章","default":"art","children":{"arttype":{"text":"文章分类","url":"?m=art-type"},"arttopic":{"text":"文章专题","url":"?m=art-topic"},"artrepeat":{"text":"检测重复数据","url":"?m=art-list-repeat-ok"},"art":{"text":"文章数据","url":"?m=art-list"},"artadd":{"text":"添加文章","url":"?m=art-info"}}},
	
	"mg":{"text":"用户","default":"user","children":{"manager":{"text":"管理员","url":"?m=user-manager"},"usergroup":{"text":"会员组","url":"?m=user-group"},"user":{"text":"会员","url":"?m=user-list"},"usercard":{"text":"充值卡","url":"?m=user-card"}}},
	
	"mh":{"text":"模版","default":"template","children":{"template":{"text":"页面模板","url":"?m=template-list"},"custom":{"text":"自定义页面","url":"?m=template-list-label-show"},"ads":{"text":"自定义广告","url":"?m=template-ads"},"wizard":{"text":"标签向导","url":"?m=template-wizard"}}},
	
	"mi":{"text":"生成","default":"make","children":{"make":{"text":"生成选项","url":"?m=make-option"},"makeindex":{"text":"生成首页","url":"?m=make-index"},"makemap":{"text":"生成地图","url":"?m=make-map"},"makeartindex":{"text":"生成文章首页","url":"?m=make-index-tab-art"},"makeartmap":{"text":"生成文章地图","url":"?m=make-map-tab-art"}}},
	
	"mk":{"text":"采集","default":"maccj","children":{"maccj":{"text":"联盟资源库","url":"?m=collect-union"},"ds":{"text":"定时挂机采集","url":"?m=collect-ds"} }},
