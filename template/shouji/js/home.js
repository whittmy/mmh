...
var FF = {
	...
	'History': {
		...
		'Create': function($id){
			...
			html +='<p><a class="close-his" href="javascript:void(0);"  onclick="FF.History.Hide();" target="_self">关闭</a><a class="clear-his" href="javascript:void(0);" onclick="FF.History.Clear();" target="_self">清空记录</a></p><ul class="highlight" id="playhistory">';
			if(jsondata.length > 0){
				for($i=0; $i<jsondata.length; $i++){
					html +='<li><h5><a href="'+jsondata[$i].vodlink+'">'+jsondata[$i].vodname+'</a><a href="'+jsondata[$i].vodlink+'" style="color:#999; padding-left:5px; font-size:10px;">'+jsondata[$i].vodtitle+'</a></h5><label><a class="color" href="'+jsondata[$i].vodlink+'">继续观看</a></label></li>';
				}
			}else{
